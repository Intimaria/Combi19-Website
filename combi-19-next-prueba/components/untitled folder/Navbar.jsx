...
const Navbar = ({ userData }) => {
    ...
    const loginRegistrationMenu = (
        <div>
            ...
            <Link href="/login" className="btn btn-dark mr-2"><a> Iniciar sesión </a></NavLink>
            <Link href="/register" className="btn btn-dark mr-2"><a> Registrar </a></NavLink>
        </div>
    )
    const logoutOption = (
    ...
    const driverMenu = (
        <div >
            ...
            <Link href="/pendingTrips" className="btn btn-dark mr-2"><a> Viajes pendientes </a></NavLink>
            <NavLink href="/tripsMade" className="btn btn-dark mr-2"><a> Viajes realizados </a></NavLink>
        </div>
    )
    const adminMenu = (
        <div>
